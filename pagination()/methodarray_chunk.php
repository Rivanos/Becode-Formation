<?php
// NOTE: Attention arry_chunk coupe en 4 les tableaux mais prends le 1, 5, 9, 13 ième éléments.
if (isset($_GET["page"])) {
...
$nbDePages = floor(count($contenu)/4) + 1;
...
$contenuCoupé = (array_chunk_vertical($contenu, 4));
?>
  ...
  <body>
    <?php
          for ($i= 1 ; $i < $nbDePagesFor ; $i++) {?>
            <a href="methodarray_chunk.php?page=<?= $i?>"><?= $i ?></a> -
          <?php }
